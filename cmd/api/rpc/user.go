...
func CreateUser(ctx context.Context, req *userModel.CreateUserRequest) error {
...
func CheckUser(ctx context.Context, req *userModel.CheckUserRequest) (int64, error) {
